...
const suggestions: HTMLSelectElement = document.getElementById("suggestions") as HTMLSelectElement;
...
function updateSuggestions(matches: string[]): void {
  ...
  for (let element in matches) {
    suggestions!.innerHTML += "<li tabindex='0'>" + matches[element] + "</li>"
  }
}
